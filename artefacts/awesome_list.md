# Awesome Example List [![Awesome][awesome-badge]][awesome-link]

> A curated list of awesome examples :tada:

An example cookiecutter-awesome project template.
...
To the extent possible under law, Author Name has waived all copyright
